...
# Parsing + Configuration Script – Dragino LHT65N-VIB - Rev. A

This **Parsing + Configuration** script is designed for the **Dragino LHT65N-VIB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Dragino LHT65N-VIB Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Dragino LHT65N-VIB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
